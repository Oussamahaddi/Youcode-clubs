    ...
    <section class="dashboard_header">
        ...
        <div class="tableaux_membre">
            <table>
                ...
                <tr>
                    <td><img src="./Sass/images/art 1.png" alt="" width="50px" align="center"> <span>oussama haddi</span></td>
                    <td>Ada lovelace</td>
                ...
                <tr>
                    ...
                    <td>oussama@gmail.com</td>
                    <td>Sport</td>
                    <td> <div><img src="./Sass/images/🦆 icon _edit outline_.png" alt="" width="20px"><img src="./Sass/images/🦆 icon _trash 2 outline_.png" alt="" width="20px"></div> </td>
                </tr>
            </table>
        </div>
    </section>
